  ...
  <body class="skin-yellow">
    ...
    <div class="wrapper">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php echo $_SESSION["nombre"] ?> - Gerente
                      <small>Homecente 2015</small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="subgerente.php"><i class="fa fa-home"></i> Inicio</a></li>     
            <li class="treeview">
              <a href="#">
      ...
      <footer class="main-footer">
        ...
        <strong>Colegio San Jose 2015</a>.</strong> Todos los derechos reservados.
      </footer>
    </div><!-- ./wrapper -->
