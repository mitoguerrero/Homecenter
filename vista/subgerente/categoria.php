          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="colaborador.php"><i class="fa fa-circle-o"></i> Gestión de Colaboradores</a></li>
                <li class=""><a href="periodo.php"><i class="fa fa-circle-o"></i> Gestión de Periodos</a></li>
                <li class="active"><a href="categoria.php"><i class="fa fa-circle-o"></i> Gestión de Categoria de Incidencia</a></li>
                ...
                <form id="frmcategoria">
                  ...
                  <div class="box-footer">
                      <div class="row">
                        ...
                        <div class="col-lg-8">
                          <input type="text" name="buscar" id="buscar" class="form-control" placeholder="Buscar Categoría">
                        </div>
                        <div class="col-lg-2">
