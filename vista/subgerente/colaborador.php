          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="colaborador.php"><i class="fa fa-circle-o"></i> Gestión de Colaboradores</a></li>
              ...
              <div class="box box-primary">
                ...
                <form id="frmcolaborador">
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                      <input type="text" class="form-control" name="txtnombre" id="txtnombre" required onchange="camposMayus(this)"><br>
                    </div>
                    <div class="col-lg-4">
                      <label>Apellidos:</label>
                    </div>
                    <div class="col-lg-8">
                      <input type="text" class="form-control" name="txtapellido" id="txtapellido" required onchange="camposMayus(this)"><br>
                    </div>
                    <div class="col-lg-4">
                      <label>Dni:</label>
                    </div>
                    <div class="col-lg-8">
                      <input type="text" class="form-control" name="txtdni" id="txtdni" required maxlength="8"><br>
                    </div>
                    <div class="col-lg-4">
                      <label>Correo:</label>
                    </div>
                    <div class="col-lg-8">
                      <input type="email" class="form-control" name="txtcorreo" id="txtcorreo" required><br>
                    </div>
                    <div class="col-lg-4">
                      <label>Dirección:</label>
                    </div>
                    <div class="col-lg-8">
                      <input type="text" class="form-control" name="txtdireccion" id="txtdireccion" required onchange="camposMayus(this)"><br>
                    </div>
                    <div class="col-lg-4">
                      <label>Teléfono:</label>
                    </div>
                    <div class="col-lg-8">
                      <input type="text" class="form-control" name="txttelefono" id="txttelefono" required><br>
                    </div>
                    <div class="col-lg-4">
                      <label>Fecha de Nacimiento:</label>
                    </div>
                    <div class="col-lg-8">
                      <input type="text" class="form-control" name="txtfechanacimiento" id="txtfechanacimiento" required><br>
                    </div>
                    <div class="col-lg-4">
                      <label>Fecha de Ingreso:</label>
                    </div>
                    <div class="col-lg-8">
                      <input type="text" class="form-control" name="txtfechaingreso" id="txtfechaingreso" required><br>
                    </div>
                  ...
                  <div class="box-footer">
                      <div class="row">
                        ...
                        <div class="col-lg-8">
                          <input type="text" name="buscar" id="buscar" class="form-control" placeholder="Buscar Colaborador %%">
                        </div>
                        <div class="col-lg-2">
