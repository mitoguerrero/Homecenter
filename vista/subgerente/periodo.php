          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="periodo.php"><i class="fa fa-circle-o"></i> Gestión de Periodos</a></li>
                ...
                <form id="frmperiodo">
                  ...
                  <div class="box-footer">
                      <div class="row">
                        ...
                        <div class="col-lg-8">
                          <input type="text" name="buscar" id="buscar" class="form-control" placeholder="Buscar Periodo">
                        </div>
                        <div class="col-lg-2">
