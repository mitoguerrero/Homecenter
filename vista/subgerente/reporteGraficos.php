...
<html>
  ...
  <body class="skin-yellow">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="reporteGraficos.php"><i class="fa fa-circle-o"></i> Gráficos</a></li>
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <input type="text" name="txtcolaborador" id="txtcolaborador" class="form-control"><br>
                        <input type="hidden" name="idcolaborador" id="idcolaborador" value="0"> 
                      </div>
                      <button class="btn btn-success center-block" onclick="buscarGrafico();">Buscar</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script src="../../public/chartjs/Chart.min.js" type="text/javascript"></script>
    <script src="../../public/plugins/jQuery/validator.js"></script>
    <script src="reporteGraficos.js" type="text/javascript"></script>
  </body>
</html>