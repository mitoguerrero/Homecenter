...
<html>
  ...
  <body class="skin-yellow">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="reporteResultados.php"><i class="fa fa-circle-o"></i> Resultados e Interpretación</a></li>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <select class="form-control" name="txtbuscar" id="txtbuscar" onchange="elegir(this.value);">
                          ...
                          <option value="3">Por Resultado</option>
                        </select><br>
                      </div>
                      ...
                      <div id="porresultado">
                        ...
                        <div class="col-lg-8">
                          <select class="form-control" name="txtperiodo2" id="txtperiodo2" onchange="cargarEvaluaciondos();">
                            <option value="0">Elegir Periodo</option>
                          </select><br>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                          <select class="form-control" name="txtevaluacion2" id="txtevaluacion2">
                            <option value="0">Elegir Evaluación</option>
                          </select><br>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                          <select class="form-control" name="txtresultado" id="txtresultado">
                            <option value="0">Elegir Resultado</option>
                        ...
                        <button class="btn btn-success center-block" onclick="buscarPorResultado();">Buscar</button>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script src="reporteResultados.js" type="text/javascript"></script>
  </body>
</html>